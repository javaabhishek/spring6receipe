...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void loadData() {
        ...
        guacRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), guacRecipe,eachUom));
        guacRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), guacRecipe,teaspoonUom));
        guacRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), guacRecipe,eachUom));
        guacRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), guacRecipe,teaspoonUom));
        guacRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), guacRecipe,eachUom));
